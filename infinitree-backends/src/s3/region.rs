...
// Original code by the [rust-s3](https://github.com/durch/rust-s3) project.
...
pub enum Region {
    ...
    SaEast1,
    /// Digital Ocean nyc3
    #[serde(rename = "digitalocean-nyc3")]
    DoNyc3,
    /// Digital Ocean ams3
    #[serde(rename = "digitalocean-ams3")]
    DoAms3,
    /// Digital Ocean sgp1
    #[serde(rename = "digitalocean-sgp1")]
    DoSgp1,
    /// Digiral Ocean fra1
    #[serde(rename = "digitalocean-fra1")]
    DoFra1,
    /// Custom region
    #[serde(rename = "custom")]
...
impl Region {
    pub fn endpoint(&self) -> String {
        ...
        match *self {
            ...
            UsEast1 => String::from("https://s3.amazonaws.com"),
            UsEast2 => String::from("https://s3-us-east-2.amazonaws.com"),
            UsWest1 => String::from("https://s3-us-west-1.amazonaws.com"),
            UsWest2 => String::from("https://s3-us-west-2.amazonaws.com"),
            CaCentral1 => String::from("https://s3-ca-central-1.amazonaws.com"),
            AfSouth1 => String::from("https://s3-af-south-1.amazonaws.com"),
            ApEast1 => String::from("https://s3-ap-east-1.amazonaws.com"),
            ApSouth1 => String::from("https://s3-ap-south-1.amazonaws.com"),
            ApNortheast1 => String::from("https://s3-ap-northeast-1.amazonaws.com"),
            ApNortheast2 => String::from("https://s3-ap-northeast-2.amazonaws.com"),
            ApNortheast3 => String::from("https://s3-ap-northeast-3.amazonaws.com"),
            ApSoutheast1 => String::from("https://s3-ap-southeast-1.amazonaws.com"),
            ApSoutheast2 => String::from("https://s3-ap-southeast-2.amazonaws.com"),
            CnNorth1 => String::from("https://s3.cn-north-1.amazonaws.com.cn"),
            CnNorthwest1 => String::from("https://s3.cn-northwest-1.amazonaws.com.cn"),
            EuNorth1 => String::from("https://s3-eu-north-1.amazonaws.com"),
            EuCentral1 => String::from("https://s3.eu-central-1.amazonaws.com"),
            EuWest1 => String::from("https://s3-eu-west-1.amazonaws.com"),
            EuWest2 => String::from("https://s3-eu-west-2.amazonaws.com"),
            EuWest3 => String::from("https://s3-eu-west-3.amazonaws.com"),
            SaEast1 => String::from("https://s3-sa-east-1.amazonaws.com"),
            MeSouth1 => String::from("https://s3-me-south-1.amazonaws.com"),
            DoNyc3 => String::from("https://nyc3.digitaloceanspaces.com"),
